...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个算法工程师, Hi，我是一个开源开发者, Hi，我是一个AI折腾的人, 我坚信，善意的AI能生产幸福❤️ ',
  ...
  //   ********挂件组件相关********
  // Chatbase
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'ebRA1p1zUOAMpD2rJBo3J', // 是否显示chatbase机器人 https://www.chatbase.co/
  // 悬浮挂件
